...
namespace Hyperletter.Dispatcher {
    public class DelegateDispatcher : AbstractDispatcher, IDelegateDispatcher {
        private readonly DictionaryList<Type, Registration> _registry = new DictionaryList<Type, Registration>();

        public DelegateDispatcher(IAbstractHyperSocket hyperSocket, ITransportSerializer serializer) : base(hyperSocket, serializer) {
        }
